...
var Plays = (function () {
  ...
  var LIST = [
    ...
    /* ---------------------------------------------------------------- RUNS */
    {
      ...
      steps: ['Quarterback gives the ball to the Running Back.',
              'The {WR} runs by and pretends to take it.',
              'The Running Back runs up the {R} side!'],
      assignments: {
        C:  { say: 'Snap the ball, run up at an angle to the {L}, then turn around and come back.',
        ...
        WR: { say: 'Run behind everybody and FAKE taking the ball, then keep going {L} and up the field.',
              segs: [{ style: 'solid', pts: [[80,70],[63,84]] },
                     { style: 'fake',  pts: [[63,84],[43,84]] },
                     { style: 'solid', pts: [[43,84],[31,63]] }] },
        QB: { say: 'Catch the snap, FAKE it to the Wide Receiver running by, then give it to the Running Back.',
...

    {
      ...
      about: 'Run way around the outside!',
      steps: ['The {WR} runs across behind everybody.',
              'Quarterback gives him the ball.',
              'He runs way around the {L} side!'],
      assignments: {
        ...
        QB: { say: 'Catch the snap, FAKE it to the Running Back, then give it to the Wide Receiver coming across.',
              segs: [{ style: 'solid', pts: [[50,77],[50,80]] }] },
...

    {
      ...
      about: 'A trick! The Running Back GIVES the ball away.',
      steps: ['Running Back takes the ball and goes {R}.',
              'The {WR} takes it from him.',
              'Now he runs the other way, {L}!'],
      assignments: {
        C:  { say: 'Snap the ball, run straight up, then cut to the {R}.',
              segs: [{ style: 'solid', pts: [[50,70],[50,56],[64,56]] }] },
        WL: { say: 'Run straight down the field!',
        ...
        QB: { say: 'Catch the snap and give it to the Running Back.',
              segs: [{ style: 'solid', pts: [[50,77],[50,80]] }] },
        RB: { say: 'Take the ball, run {R}, then give it to the Wide Receiver coming across. Keep running!',
...

    {
      ...
      about: 'Looks the same — but he KEEPS the ball!',
      steps: ['Running Back takes the ball and goes {R}.',
              'The {WR} only PRETENDS to take it.',
              'The Running Back keeps it and runs {R}!'],
      assignments: {
        C:  { say: 'Snap the ball, run straight up, then cut to the {L}.',
              segs: [{ style: 'solid', pts: [[50,70],[50,56],[36,56]] }] },
        WL: { say: 'Run up a few steps, then turn around and come back.',
              segs: [{ style: 'solid', pts: [[20,70],[20,44],[24,49]] }] },
        WR: { say: 'Come across and FAKE taking the ball, then keep running {L}.',
              segs: [{ style: 'fake',  pts: [[80,70],[64,82]] },
                     { style: 'solid', pts: [[64,82],[41,84],[29,63]] }] },
        QB: { say: 'Catch the snap and give it to the Running Back.',
              segs: [{ style: 'solid', pts: [[50,77],[50,80]] }] },
        RB: { say: 'Take the ball, FAKE it to the Wide Receiver, then KEEP IT and run {R}!',
              ballCarrier: true,
    ...
    /* ------------------------------------------------------------- PASSES */
    {
      ...
      about: 'Looks like Sweep — then a throw!',
      steps: ['The Center snaps, then runs {L}.',
              'Quarterback gives the ball to the {WR}.',
              'He runs {L}, stops, and throws to the Center!'],
      assignments: {
        ...
        QB: { say: 'Catch the snap and give it to the Wide Receiver coming across.',
              segs: [{ style: 'solid', pts: [[50,77],[50,80]] }] },
...

    {
      ...
      about: 'A fake, then a throw to the Running Back!',
      steps: ['Quarterback PRETENDS to give it to the Running Back.',
      ...
      assignments: {
        ...
        QB: { say: 'Catch the snap, FAKE it to the Running Back, then throw it {R} to him.',
              segs: [{ style: 'solid', pts: [[50,77],[50,80]] }] },
        RB: { say: 'FAKE like you are taking it, then slip out and cut {R}. Catch the ball!',
              ballCarrier: true,
...

    {
      ...
      steps: ['Quarterback PRETENDS to give it to the Running Back.',
              'The {WL} runs, then turns to the middle.',
              'Quarterback throws it to him!'],
      assignments: {
        C:  { say: 'Snap the ball, run straight up, then cut to the {R}.',
              segs: [{ style: 'solid', pts: [[50,70],[50,56],[64,56]] }] },
        ...
        QB: { say: 'Catch the snap, FAKE it to the Running Back, then throw it {L}.',
              segs: [{ style: 'solid', pts: [[50,77],[50,80]] }] },
...

    {
      ...
      steps: ['The Center snaps, runs up, then turns {R}.',
              'The {WR} runs across like a Sweep.',
              'Quarterback FAKES, then throws to the Center!'],
      assignments: {
        ...
        QB: { say: 'Catch the snap, FAKE it to the Running Back, then throw it {R} to the Center.',
              segs: [{ style: 'solid', pts: [[50,77],[50,80]] }] },
        RB: { say: 'FAKE like you are taking the ball, then run straight down the field.',
              segs: [{ style: 'fake',  pts: [[50,85],[58,76]] },
